...
HD_PWD='E:/vivado/lab_1/lab_1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log mux4to1_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source mux4to1_1.tcl
