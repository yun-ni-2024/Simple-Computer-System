...
HD_PWD='E:/vivado/lab_8_1_div8u_res/lab_8_1_div8u_res.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log div8u_res.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source div8u_res.tcl
