...
HD_PWD='E:/vivado/lab_5_2_clk1s/lab_5_2_clk1s.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log clk1s.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source clk1s.tcl -notrace
