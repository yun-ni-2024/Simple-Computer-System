...
HD_PWD='E:/vivado/lab_5_2_clk1s/lab_5_2_clk1s.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log clk1s.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source clk1s.tcl
