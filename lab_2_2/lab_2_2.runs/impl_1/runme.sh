...
HD_PWD='E:/vivado/lab_2_2/lab_2_2.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log enc8to3.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source enc8to3.tcl -notrace
