...
HD_PWD='E:/vivado/lab_2_2/lab_2_2.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log enc8to3.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source enc8to3.tcl
