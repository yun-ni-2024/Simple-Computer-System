...
HD_PWD='E:/vivado/lab_5_cntr32u/lab_5_cntr32u.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log cntr32u.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source cntr32u.tcl
