...
HD_PWD='E:/vivado/lab_9_inoutlab/lab_9_inoutlab.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log inoutlab.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source inoutlab.tcl
