...
HD_PWD='E:/vivado/lab_9_inoutlab/lab_9_inoutlab.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log inoutlab.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source inoutlab.tcl -notrace
