...
HD_PWD='E:/vivado/lab_8_1_div8u_unres/lab_8_1_div8u_unres.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log div8u_unres.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source div8u_unres.tcl
