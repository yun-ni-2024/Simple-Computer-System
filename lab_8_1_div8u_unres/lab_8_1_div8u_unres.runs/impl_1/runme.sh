...
HD_PWD='E:/vivado/lab_8_1_div8u_unres/lab_8_1_div8u_unres.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log div8u_unres.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source div8u_unres.tcl -notrace
