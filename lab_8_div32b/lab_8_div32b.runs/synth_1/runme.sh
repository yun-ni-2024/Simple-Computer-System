...
HD_PWD='E:/vivado/lab_8_div32b/lab_8_div32b.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log div32b.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source div32b.tcl
