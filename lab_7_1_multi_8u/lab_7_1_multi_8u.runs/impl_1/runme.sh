...
HD_PWD='E:/vivado/lab_7_1_multi_8u/lab_7_1_multi_8u.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log multi_8u.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source multi_8u.tcl -notrace
