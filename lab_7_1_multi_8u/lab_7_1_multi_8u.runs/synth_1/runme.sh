...
HD_PWD='E:/vivado/lab_7_1_multi_8u/lab_7_1_multi_8u.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log multi_8u.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source multi_8u.tcl
