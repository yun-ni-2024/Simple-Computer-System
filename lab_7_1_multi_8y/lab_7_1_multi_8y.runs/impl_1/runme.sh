...
HD_PWD='E:/vivado/lab_7_1_multi_8y/lab_7_1_multi_8y.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log multi_8y.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source multi_8y.tcl -notrace
