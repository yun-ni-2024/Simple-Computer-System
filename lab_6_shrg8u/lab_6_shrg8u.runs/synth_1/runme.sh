...
HD_PWD='E:/vivado/lab_6_shrg8u/lab_6_shrg8u.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log shrg8u.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source shrg8u.tcl
