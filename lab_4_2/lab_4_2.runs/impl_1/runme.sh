...
HD_PWD='E:/vivado/lab_4_2/lab_4_2.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log d_register.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source d_register.tcl -notrace
