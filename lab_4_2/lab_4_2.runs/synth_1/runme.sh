...
HD_PWD='E:/vivado/lab_4_2/lab_4_2.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log d_register.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source d_register.tcl
