...
HD_PWD='E:/vivado/lab_8_2_div8b/lab_8_2_div8b.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log div8b.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source div8b.tcl
