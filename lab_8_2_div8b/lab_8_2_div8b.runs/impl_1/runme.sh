...
HD_PWD='E:/vivado/lab_8_2_div8b/lab_8_2_div8b.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log div8b.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source div8b.tcl -notrace
