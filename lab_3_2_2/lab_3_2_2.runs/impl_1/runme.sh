...
HD_PWD='E:/vivado/lab_3_2/lab_3_2.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log ALU8.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source ALU8.tcl -notrace
