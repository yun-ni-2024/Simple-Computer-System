...
namespace eval ::optrace {
  variable script "E:/vivado/lab_13/lab_13.runs/impl_1/Top.tcl"
...
OPTRACE "add files" START { }
  add_files -quiet E:/vivado/lab_13/lab_13.runs/synth_1/Top.dcp
...
OPTRACE "Write Bitstream: pre hook" START { }
  set src_rc [catch { 
    puts "source E:/vivado/bit.tcl"
    source E:/vivado/bit.tcl
  } _RESULT] 
  if {$src_rc} { 
    set tool_flow [get_property -quiet TOOL_FLOW [current_project -quiet]]
    if { $tool_flow eq {SDx} } { 
      send_gid_msg -id 2 -ssname VPL_TCL -severity ERROR $_RESULT
      send_gid_msg -id 3 -ssname VPL_TCL -severity ERROR "sourcing script E:/vivado/bit.tcl failed"
    } else {
      send_msg_id runtcl-1 status "$_RESULT"
      send_msg_id runtcl-2 status "sourcing script E:/vivado/bit.tcl failed"
    }
    return -code error
  }
