...
HD_PWD='E:/vivado/lab_4_2_8reg/lab_4_2_8reg.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log d_reg8.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source d_reg8.tcl
