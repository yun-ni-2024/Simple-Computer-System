...
HD_PWD='E:/vivado/lab_4_2_8reg/lab_4_2_8reg.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log d_reg8.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source d_reg8.tcl -notrace
