...
HD_PWD='E:/vivado/lab_1_2/lab_1_2.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log dmux4to1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source dmux4to1.tcl
