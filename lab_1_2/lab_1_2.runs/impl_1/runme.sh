...
HD_PWD='E:/vivado/lab_1_2/lab_1_2.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log dmux4to1.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source dmux4to1.tcl -notrace
