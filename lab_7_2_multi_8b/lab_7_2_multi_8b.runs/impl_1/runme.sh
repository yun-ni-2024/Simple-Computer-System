...
HD_PWD='E:/vivado/lab_7_2_multi_8b/lab_7_2_multi_8b.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log multi_8b.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source multi_8b.tcl -notrace
