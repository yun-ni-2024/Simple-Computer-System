...
HD_PWD='E:/vivado/lab_7_multi_32b/lab_7_multi_32b.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log multi_32b.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source multi_32b.tcl
