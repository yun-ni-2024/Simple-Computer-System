...
HD_PWD='E:/vivado/lab_7_multi_32z/lab_7_multi_32z.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log multi_32z.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source multi_32z.tcl
