...
HD_PWD='E:/vivado/lab_0/lab_0.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log my_first_fpga.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source my_first_fpga.tcl -notrace
