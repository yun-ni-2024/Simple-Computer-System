...
HD_PWD='E:/vivado/lab_0/lab_0.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log my_first_fpga.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source my_first_fpga.tcl
