...
HD_PWD='E:/vivado/lab_5_milliseconds/lab_5_milliseconds.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log miliseconds.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source miliseconds.tcl -notrace
