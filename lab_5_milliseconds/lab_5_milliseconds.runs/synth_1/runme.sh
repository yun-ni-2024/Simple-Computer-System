...
HD_PWD='E:/vivado/lab_5_milliseconds/lab_5_milliseconds.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log miliseconds.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source miliseconds.tcl
