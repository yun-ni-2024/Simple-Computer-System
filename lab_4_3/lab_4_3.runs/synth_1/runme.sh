...
HD_PWD='E:/vivado/lab_4_3/lab_4_3.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log d_reg8file.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source d_reg8file.tcl
