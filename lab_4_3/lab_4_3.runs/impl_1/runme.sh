...
HD_PWD='E:/vivado/lab_4_3/lab_4_3.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log d_reg8file.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source d_reg8file.tcl -notrace
