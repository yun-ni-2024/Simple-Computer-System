...
HD_PWD='E:/vivado/lab_5_1_cntr4u/lab_5_1_cntr4u.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log cntr4u.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source cntr4u.tcl -notrace
