...
HD_PWD='E:/vivado/lab_5_1_cntr4u/lab_5_1_cntr4u.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log cntr4u.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source cntr4u.tcl
