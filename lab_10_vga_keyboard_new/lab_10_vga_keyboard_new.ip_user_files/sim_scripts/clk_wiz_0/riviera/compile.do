...
vlog -work xpm  -sv2k12 "+incdir+../../../ipstatic" "+incdir+../../../../../lab_10_keyboard/lab_10_keyboard.gen/sources_1/ip/clk_wiz_0" \
"D:/Vivado/2020.2/data/ip/xpm/xpm_cdc/hdl/xpm_cdc.sv" \

vcom -work xpm -93 \
"D:/Vivado/2020.2/data/ip/xpm/xpm_VCOMP.vhd" \

vlog -work xil_defaultlib  -v2k5 "+incdir+../../../ipstatic" "+incdir+../../../../../lab_10_keyboard/lab_10_keyboard.gen/sources_1/ip/clk_wiz_0" \
