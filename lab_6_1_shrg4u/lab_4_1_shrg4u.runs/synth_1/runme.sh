...
HD_PWD='E:/vivado/lab_6_1_shrg4u/lab_4_1_shrg4u.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log shrg4u.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source shrg4u.tcl
