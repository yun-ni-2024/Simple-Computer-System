...
HD_PWD='E:/vivado/lab_6_1_shrg4u/lab_4_1_shrg4u.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log shrg4u.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source shrg4u.tcl -notrace
