...
HD_PWD='E:/vivado/lab_8_div32u/lab_8_div32u.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log div32u.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source div32u.tcl
