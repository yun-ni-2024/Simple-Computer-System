...
HD_PWD='E:/vivado/lab_8_div32u/lab_8_div32u.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log div32u.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source div32u.tcl -notrace
