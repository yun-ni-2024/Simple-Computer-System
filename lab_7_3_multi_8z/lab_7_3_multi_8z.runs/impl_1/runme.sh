...
HD_PWD='E:/vivado/lab_7_3_multi_8z/lab_7_3_multi_8z.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log multi_8z.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source multi_8z.tcl -notrace
