...
HD_PWD='E:/vivado/lab_5_3_digitalclk/lab_5_3_digitalclk.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log digitalclk.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source digitalclk.tcl
