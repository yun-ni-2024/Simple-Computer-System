...
HD_PWD='E:/vivado/lab_5_3_digitalclk/lab_5_3_digitalclk.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log digitalclk.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source digitalclk.tcl -notrace
